...
| Parameter / Metric | Baseline Architecture (v1.0.0) | Centered Continuous (1200 RPM) | Centered Locked-Rotor (0 RPM Peak) | Mirrored Polarity Pulsed (N-S) | Closed Can (1200 RPM, Lids) | Closed Can Thirds Handover (Al Metasurface) | Ferromagnetic Iron Cage (Magnetic Shunt) | Ferromagnetic Expanded Mesh (Hybrid Metamaterial) | Triplo Strato X + Rotore PEEK (Amagnetic Core) | Gabbia Sferica Doppio Rotore 90° (Multi-Axis Shaper) | NPNPNP Single PEEK (Continuous 120°) | NPNPNP Dual 90° Spherical (Continuous 120°) | Physical Mechanism / Specialty |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Core Geometry** | Ferromagnetic spider at bottom (Z = -H/2) | Ferromagnetic core at equator (Z = 0) | Ferromagnetic core at equator (Z = 0) | Ferromagnetic core at equator (Z = 0) | Equatorial Core (Z = 0), Closed Can (Z = ±H/2) | Equatorial Core (Z = 0), Closed Can (Z = ±H/2) | Equatorial Core (Z = 0), Iron Cage (Z = ±H/2) | Equatorial Core (Z = 0), Closed Can (Z = ±H/2) | **Amagnetic PEEK Core (Z = 0), Closed Can (Z = ±H/2)** | **Doppio Rotore Ortogonale (Z & X) + PEEK Core, Guscio Sferico (R=50 mm)** | **Amagnetic PEEK Core (Z = 0), Closed Can (Z = ±H/2)** | **Doppio Rotore Ortogonale (Z & X) + PEEK Core, Guscio Sferico (R=50 mm)** | Reluctance loop & shell shielding |
| **Coil Excitation** | 60° Progressive Full Sine Wave (100 Hz) | 60° Progressive Full Sine Wave (100 Hz) | 60° Progressive Full Sine Wave (100 Hz) | 60° Shifted Half-Wave Pulse Train (J_k ≥ 0) | 60° Progressive Full Sine Wave (100 Hz) | **Asymmetric Thirds Handover (1/3, 2/3, 100%)** | **Asymmetric Thirds Handover (1/3, 2/3, 100%)** | **Asymmetric Thirds Handover (1/3, 2/3, 100%)** | **Asymmetric Thirds Handover (1/3, 2/3, 100%)** | **Handover a terzi incrociato a 90° (100 Hz, quadratura Z & X)** | **Continuous 3-Phase NPNPNP (100 Hz, 3 pairs at 120°)** | **Dual Continuous 3-Phase NPNPNP (100 Hz, 90° Quadrature)** | Directional vs Sequenced Pulsed vs Continuous Traveling Wave |
| **Rotor Speed & Slip** | 1200 RPM (f_slip = 40 Hz) | 1200 RPM (f_slip = 40 Hz) | **0 RPM (Locked, f_slip = 100 Hz)** | 1200 RPM (f_slip = 40 Hz) | 1200 RPM (f_slip = 40 Hz) | **0 RPM (Solid-State Static Operation)** | **0 RPM (Solid-State Static Operation)** | **0 RPM (Solid-State Static Operation)** | **0 RPM (Solid-State Static Operation)** | **0 RPM (Solid-State 3D Vector Shaper)** | **0 RPM (Solid-State Traveling Wave)** | **0 RPM (Solid-State 3D Vector Shaper)** | Mechanical tracking vs maximum relative slip |
| **Polarity Layout** | Unipolar Homogeneous | Unipolar Homogeneous | Unipolar Homogeneous | Alternating Mirrored: s_k = (-1)^(k-1) | Unipolar Homogeneous | **3 Diametral Pairs (180°), Opposed PN/NP** | **3 Diametral Pairs (180°), Opposed PN/NP** | **3 Diametral Pairs (180°), Opposed PN/NP** | **3 Diametral Pairs (180°), Opposed PN/NP** | **Due array ortogonali a 3 coppie diametrali (180°)** | **Alternating Clockwise N-P-N-P-N-P (120°)** | **Dual Orthogonal Arrays (Z & X), 6 Coils NPNPNP each** | Diametral flux antisymmetry & polyphase symmetry |
| **Mantle Material & Permeability** | Aluminum Mesh (µr = 1.0) | Aluminum Mesh (µr = 1.0) | Aluminum Mesh (µr = 1.0) | Aluminum Mesh (µr = 1.0) | Aluminum Mesh (µr = 1.0) | **Aluminum Mesh EN AW-1050A (µr = 1.0)** | **Soft Iron Armco (µr = 1000.0, σ = 10^7)** | **Ferro Mesh (µr = 1000.0, 30° Louver)** | **Triplo Strato X (µr = 1000.0, +30°/0°/-30°)** | **Guscio Sferico X (µr = 1000.0, +30°/0°/-30°)** | **Triplo Strato X (µr = 1000.0, +30°/0°/-30°)** | **Guscio Sferico X (µr = 1000.0, +30°/0°/-30°)** | Metasurface vs Magnetic Shunt vs X-Chiral |
| **Radial Field B_rad (R = 6.5 cm)** | **62.98 µT** | **211.35 µT** | **211.35 µT** | **135.84 µT** | **185.2 µT** | **1970.2 µT** | **2271.0 µT** | **3137.0 µT (3.14 mT)** | **1153.2 µT (1.15 mT)** | **125.2 µT (Picco: 1401.4 µT)** | **428.0 µT (Picco: 3439.9 µT)** | **8817.0 µT (8.82 mT, Picco: 91.2 mT)** | High near-field concentration & continuous synthesis |
| **Induced E-Field |E| (Far-Field R = 15 cm)** | ~ 15 mV/m | ~ 8 mV/m | ~ 8 mV/m | ~ 45 mV/m | ~ 2.0 mV/m | **4.89 mV/m** | **0.54 mV/m (-89.0% E-field suppression)** | **53.96 mV/m** | **81.50 mV/m** | **1614.7 mV/m (Campo Elettrodinamico 3D)** | **3.38 mV/m** | **72757.1 mV/m (72.8 V/m)** | Passive shielding vs high chiral projection |
| **Net Lorentz Force <F>** | ≈ 0 (leakage) | **+4.67 µN** | **+5.72 µN (+57.2 mN full scale)** | **-0.93 µN (≈ 0 mN balanced)** | **-0.20 µN (F_z,chiral = -0.04 µN)** | **+0.028 µN (Positive DC Lift)** | **+3.346 µN (Mantle: -13.49 µN, Core: +14.62 µN)** | **+113.51 µN (Mantle: -19.76 µN, Core: +126.77 µN)** | **+36.99 µN (Can: +3.29 µN, Core: +33.53 µN)** | **⟨Fx⟩ = +657.6 µN, ⟨Fy⟩ = +39.0 µN, ⟨Fz⟩ = -490.5 µN** | **|⟨F⟩| = 849.1 µN (Fx: -288.9, Fy: -797.7, Fz: -35.9 µN)** | **|⟨F⟩| = 984.7 mN ≈ 0.985 N (Fx: +809.0, Fy: -16.9, Fz: -561.2 mN)** | Continuous traveling wave vs pulsed handover thrust |
| **Peak Instantaneous Force F_max** | ≈ 0 | +27.41 µN | **+12.89 µN (+128.9 mN full scale)** | ±26.50 µN (symmetric) | -2.96 µN | **+1.161 µN** | **+316.7 µN** | **+897.6 µN** | **+142.9 µN** | **21.11 mN (Picco Vettoriale 3D)** | **808.9 µN (Can Fz: -2.79 µN)** | **14.17 N (Fx max: +14.17 N, Fz min: -16.39 N)** | Highly inductive chiral ponderomotive coupling |
| **Joule Dissipation P_J** | **2.437 W** | **1.52 mW** | **1.02 mW (0.0010 W)** | **1.90 mW (0.0019 W)** | **0.017 mW (17.4 µW)** | **0.0088 mW (8.83 µW)** | **0.172 mW (172.15 µW, 19.5x vs Al)** | **Eddy loop breaking in µr = 1000** | **X-crossed eddy suppression in µr = 1000** | **182.2 µW (Mantello: 33.0 µW, Rotori: 146.6 µW)** | **56.78 mW (Mantle: 36.65 mW, Coils: 20.13 mW)** | **230.30 W (Rotor 1: 100.7 W, Rotor 2: 82.0 W, Mantle: 44.5 W)** | Chiral metasurface slashes eddy losses |
| **Force Efficiency η_F = |F| / P_J** | ~ 0 | 3065 µN/W | **5587 µN/W** | ≈ 0 (balanced) | N/A (Confined Cavity) | **3194 µN/W** | **19438 µN/W** | **Ultra-High Thrust Coupling** | **Balanced Parity-Stabilized Thrust** | **4509 µN/W (Vettoriale 3D Multi-Asse)** | **14953 µN/W** | **4276 µN/W (4.28 mN/W)** | Solid-state force-to-power metric |
| **Primary Optimal Use-Case** | Directional Wireless Venting | Continuous Electromagnetic Lift | **Max Lorentz Lift (Solid-State Thruster)** | Resonant Wireless Pulsed Power & Low Heat | **Ultra-Low Loss Confined Cavity** | **Cusp Divergence & Sub-10 µW Thruster** | **Magnetic Shunting & Passive Radiation Shield** | **High-Thrust Electromagnetic Propulsion** | **Parity-Stabilized Solid-State Lift & PEEK Core** | **Orientamento Vettoriale Multi-Asse Solid-State (3D Vector Thruster)** | **Continuous 360° Circular Shaper & High-Efficiency Thruster** | **High-Thrust 3D Solid-State Vector Propulsion (0.98 N Continuous)** | Mission-specific tuning |
...
### 12. Continuous NPNPNP 3-Phase Traveling Wave Campaign: Single PEEK Rotor vs Dual Orthogonal 90° Rotor
| Synoptic Comparison: 360° Circular Induction & Spatiotemporal Kymographs (300 DPI) | Full 3-Axis Force Dynamics, Space-Force Hodograph & Joule Balance (300 DPI) |
| :---: | :---: |
...
### 14. Reproduce Continuous NPNPNP 3-Phase Traveling Wave Study (Single PEEK vs Dual 90°)
```bash
# Execute transient Elmer FEM simulations for both architectures under simultaneous NPNPNP 3-phase excitation,
# perform 2,500-point Fibonacci Gauss solenoidality audits, MST surface integrals, and generate 300 DPI figures 18 & 19
